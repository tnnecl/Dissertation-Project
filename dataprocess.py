...
file1_path = 'abn_all_raw.xlsx'
file2_path = 'pob_all.xlsx'
...
print(filtered_df)
df_1.to_excel('features_all.xlsx', index=False)
...
df_2 = df_2[df_2['RigDateID'] != 'NRSU202401']
...
print(df_4m.info())
df_4m.to_excel('all_4m.xlsx', index=False)
...
print(df_1m.info())
df_1m.to_excel('all_1m.xlsx', index=False)